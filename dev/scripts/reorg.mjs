...
const js = { vendor: chunk("sections", "js"), main: chunk("index", "js"), menu: chunk("menu", "js"), webgl: chunk("counter-gl", "js") };
const css = { styles: chunk("sections", "css"), home: chunk("index", "css"), menu: chunk("menu", "css") };
const jsNames = { [js.vendor]: "vendor.js", [js.main]: "main.js", [js.menu]: "menu.js", [js.webgl]: "webgl-plate-tour.js" };
...
// JS: descriptive names, and every chunk-to-chunk specifier follows the rename.
